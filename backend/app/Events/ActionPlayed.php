...
class ActionPlayed implements ShouldBroadcast
{
    ...
    public function broadcastWith(): array
    {
        ...
        if ($this->action->type === ActionType::Question) {
            return array_merge($base, [
                'question' => $this->action->is_valid
                    ? $this->action->content
                    : null, // question refusée : on n'expose pas le contenu
                'refused_reason' => !$this->action->is_valid
